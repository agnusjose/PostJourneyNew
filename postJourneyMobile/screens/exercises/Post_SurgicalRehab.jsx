...
const EXERCISES = [
  { label: "Sit-to-Stand", key: "SIT_TO_STAND", icon: "seat-recline-normal", color: "#F59E0B", bg: "#FEF3C7" },
  { label: "Seated Knee Extension", key: "SEATED_KNEE_EXTENSION", icon: "human", color: "#0A5F7A", bg: "#E6F3F7" },
  { label: "Heel Slides", key: "HEEL_SLIDES", icon: "foot-print", color: "#8B5CF6", bg: "#EDE9FE" },
  { label: "Bed Mobility – Roll", key: "BED_MOBILITY_ROLL", icon: "bed", color: "#EF4444", bg: "#FEE2E2" },
];

export default function PostSurgicalRehabScreen({ navigation }) {
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={[C.primary, C.secondary]} style={styles.hero}>
        ...
        <View style={styles.heroCenter}>
          <MaterialCommunityIcons name="bandage" size={36} color="rgba(255,255,255,0.9)" />
          <Text style={styles.heroTitle}>Post-Surgical Rehab</Text>
          <Text style={styles.heroSub}>Safely restoring your mobility</Text>
        </View>
      </LinearGradient>
      ...
      <ScrollView contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.tipCard}>
          <LinearGradient colors={["#E6F9F5", "#F0FBF9"]} style={styles.tipGradient}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.tipTitle}>Care Note</Text>
              <Text style={styles.tipText}>
                The AI tracks your range of motion. Try to reach the target angles shown on your screen during the session.
              </Text>
            </View>
          </LinearGradient>
        </View>
