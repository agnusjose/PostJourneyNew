...
const EXERCISES = [
  { label: "Ankle Pumps", key: "ANKLE_PUMPS", icon: "foot-print", color: "#0A5F7A", bg: "#E6F3F7" },
  { label: "Seated Trunk Flexion–Extension", key: "SEATED_TRUNK_FLEXION_EXTENSION", icon: "human", color: "#F59E0B", bg: "#FEF3C7" },
];

export default function IcuGeneralScreen({ navigation }) {
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={[C.primary, C.secondary]} style={styles.hero}>
        ...
        <View style={styles.heroCenter}>
          <MaterialCommunityIcons name="hospital-building" size={36} color="rgba(255,255,255,0.9)" />
          <Text style={styles.heroTitle}>ICU & Deconditioning</Text>
          <Text style={styles.heroSub}>Gentle movements for recovery</Text>
        </View>
      </LinearGradient>
          ...
          <LinearGradient colors={["#E6F9F5", "#F0FBF9"]} style={styles.tipGradient}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.tipText}>
                Focus on smooth, controlled motions. Stop immediately if you feel any sharp pain or dizziness.
              </Text>
            </View>
          </LinearGradient>
        </View>
