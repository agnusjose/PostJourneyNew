...
const EXERCISES = [
  { label: "Marching in Place", key: "MARCHING_IN_PLACE", icon: "walk", color: "#0A5F7A", bg: "#E6F3F7" },
  { label: "Shoulder Rolls", key: "SHOULDER_ROLLS", icon: "rotate-3d-variant", color: "#8B5CF6", bg: "#EDE9FE" },
  { label: "Thoracic Expansion with Arm Lift", key: "THORACIC_EXPANSION_ARM_LIFT", icon: "human-handsup", color: "#EF4444", bg: "#FEE2E2" },
];

export default function CardiacRehabScreen({ navigation }) {
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={[C.primary, C.secondary]} style={styles.hero}>
        ...
        <View style={styles.heroCenter}>
          <MaterialCommunityIcons name="heart-pulse" size={36} color="rgba(255,255,255,0.9)" />
          <Text style={styles.heroTitle}>Cardiac Rehabilitation</Text>
          <Text style={styles.heroSub}>Heart-safe exercise protocols</Text>
        </View>
      </LinearGradient>
          ...
          <LinearGradient colors={["#E6F9F5", "#F0FBF9"]} style={styles.tipGradient}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.tipText}>
                Ensure you have enough space to move freely. Proper lighting helps the AI track your movement with 95% more accuracy.
              </Text>
            </View>
          </LinearGradient>
        </View>
