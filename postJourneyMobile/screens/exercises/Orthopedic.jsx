...
const EXERCISES = [
  { label: "Straight Leg Raise", key: "STRAIGHT_LEG_RAISE", icon: "human", color: "#059669", bg: "#D1FAE5" },
  { label: "Standing Hip Abduction", key: "STANDING_HIP_ABDUCTION", icon: "human-handsup", color: "#8B5CF6", bg: "#EDE9FE" },
  { label: "Hip Extension (Standing)", key: "HIP_EXTENSION", icon: "arrow-expand-vertical", color: "#0A5F7A", bg: "#E6F3F7" },
  { label: "Pendulum Exercise", key: "PENDULUM_EXERCISE", icon: "rotate-3d-variant", color: "#F59E0B", bg: "#FEF3C7" },
];

export default function OrthopedicScreen({ navigation }) {
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={[C.primary, C.secondary]} style={styles.hero}>
        ...
        <View style={styles.heroCenter}>
          <MaterialCommunityIcons name="bone" size={36} color="rgba(255,255,255,0.9)" />
          <Text style={styles.heroTitle}>Orthopedic Rehab</Text>
          <Text style={styles.heroSub}>Targeted joint and muscle strengthening</Text>
        </View>
      </LinearGradient>
          ...
          <LinearGradient colors={["#E6F9F5", "#F0FBF9"]} style={styles.tipGradient}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.tipText}>
                Proper alignment is key. Keep your core engaged to protect your spine during these movements.
              </Text>
            </View>
          </LinearGradient>
        </View>
