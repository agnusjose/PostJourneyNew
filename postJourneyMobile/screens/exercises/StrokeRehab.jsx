...
const EXERCISES = [
  { label: "Seated Shoulder Flexion", key: "SEATED_SHOULDER_FLEXION", icon: "seat-recline-normal", color: "#8B5CF6", bg: "#EDE9FE" },
  { label: "Seated Elbow Extension-Flexion", key: "SEATED_ELBOW_FLEXION_EXTENSION", icon: "human", color: "#0A5F7A", bg: "#E6F3F7" },
  { label: "Weight Shift", key: "WEIGHT_SHIFT", icon: "scale-balance", color: "#F59E0B", bg: "#FEF3C7" },
];

export default function StrokeRehabScreen({ navigation }) {
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={[C.primary, C.secondary]} style={styles.hero}>
        ...
        <View style={styles.heroCenter}>
          <MaterialCommunityIcons name="brain" size={36} color="rgba(255,255,255,0.9)" />
          <Text style={styles.heroTitle}>Stroke Recovery</Text>
          <Text style={styles.heroSub}>Restoring neuro-motor coordination</Text>
        </View>
      </LinearGradient>
          ...
          <LinearGradient colors={["#E6F9F5", "#F0FBF9"]} style={styles.tipGradient}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.tipText}>
                Quality over speed. The AI is looking for precise, symmetrical movements to help rewire neural pathways.
              </Text>
            </View>
          </LinearGradient>
        </View>
