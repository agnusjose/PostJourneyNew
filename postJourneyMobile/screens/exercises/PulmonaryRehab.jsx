...
const EXERCISES = [
  ...
  { label: "Static Standing Endurance", key: "STATIC_STANDING", icon: "human", color: "#0A5F7A", bg: "#E6F3F7" },
  { label: "Marching in Place", key: "MARCHING_IN_PLACE", icon: "walk", color: "#059669", bg: "#D1FAE5" },
];

export default function PulmonaryRehabScreen({ navigation }) {
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={[C.primary, C.secondary]} style={styles.hero}>
        ...
        <View style={styles.heroCenter}>
          <MaterialCommunityIcons name="lungs" size={36} color="rgba(255,255,255,0.9)" />
          <Text style={styles.heroTitle}>Pulmonary Rehab</Text>
          <Text style={styles.heroSub}>Improving lung capacity and endurance</Text>
        </View>
      </LinearGradient>
          ...
          <LinearGradient colors={["#E6F9F5", "#F0FBF9"]} style={styles.tipGradient}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.tipText}>
                Inhale deeply through your nose and exhale slowly through pursed lips for maximum benefit.
              </Text>
            </View>
          </LinearGradient>
        </View>
