...
const EXERCISES = [
  { label: "Mini Squat Exercise", key: "MINI_SQUAT", icon: "human", color: "#2EC4B6", bg: "#E6FAF8" },
  { label: "Neck Mobility Exercise", key: "NECK_MOBILITY", icon: "head-dots-horizontal", color: "#8B5CF6", bg: "#EDE9FE" },
];

export default function CommonExercisesScreen({ navigation }) {
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={[C.primary, C.secondary]} style={styles.hero}>
        ...
        <View style={styles.heroCenter}>
          <MaterialCommunityIcons name="dumbbell" size={36} color="rgba(255,255,255,0.9)" />
          <Text style={styles.heroTitle}>Common Exercises</Text>
          <Text style={styles.heroSub}>Select a mobility routine to begin</Text>
        </View>
      </LinearGradient>
